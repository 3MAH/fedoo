...
class _ProblemOutput:
    ...
    def SaveResults(self, pb, comp_output=None):
        ...
        list_filename = []
        list_ExportData = []            
        label_dict = {'pkii':'PKII', 'pk2':'PKII', 'kirchoff':'Kirchhoff', 'kirchhoff':'Kirchhoff', 'cauchy':'Cauchy',
        ...
        for output in self.__list_output:
            ...
            for res in output['list']:
                ...
                if res in ['pkii', 'pk2', 'kirchoff', 'kirchhoff', 'cauchy','strain', 'stress']:
                    ...
                    label_data = label_dict[res[:-3]] + '_Mises'
                    data = data.vonMises()
                    ...
                    if res[-3:] == '_pc': #principal component
                        ...
                        label_data = label_dict[measure_type] + '_Principal'
                    elif res[-6:] == '_pdir1': #1st principal direction    
                        data = data[1][0]
                        label_data = label_dict[measure_type] + '_PrincipalDir1'
                    elif res[-6:] == '_pdir2': #2nd principal direction    
                        data = data[1][2]
                        label_data = label_dict[measure_type] + '_PrincipalDir2'
                    elif res[-6:] == '_pdir3': #3rd principal direction    
                        data = data[1][2]
                        label_data = label_dict[measure_type] + '_PrincipalDir3'
