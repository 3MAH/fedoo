...
def DefinePeriodicBoundaryCondition(mesh, NodeEps, VarEps, dim='3D', tol=1e-8, ProblemID = 'MainProblem'):
    ...
    if dim == 2:                       
        ...
        mesh.add_node_set([left],      [numGeometricMesh], ID='left')
        mesh.add_node_set([right],     [numGeometricMesh], ID='right')
        mesh.add_node_set([top],       [numGeometricMesh], ID='top')
        mesh.add_node_set([bottom],    [numGeometricMesh], ID='bottom')
        mesh.add_node_set([corner_lb], [numGeometricMesh], ID='corner_lb')
        mesh.add_node_set([corner_rb], [numGeometricMesh], ID='corner_rb')
        mesh.add_node_set([corner_lt], [numGeometricMesh], ID='corner_lt')
        mesh.add_node_set([corner_rt], [numGeometricMesh], ID='corner_rt')
        
        mesh.add_node_set([np.full_like(right, NodeEps[0])], [numGeometricMesh], ID='EpsXX_right')
        mesh.add_node_set([np.full_like(right, NodeEps[2])], [numGeometricMesh], ID='EpsXY_right')
        mesh.add_node_set([np.full_like(top,NodeEps[2])],    [numGeometricMesh], ID='EpsXY_top')
        mesh.add_node_set([np.full_like(top,NodeEps[1])],    [numGeometricMesh], ID='EpsYY_top')        
        mesh.add_node_set([np.full_like(corner_lt,NodeEps[0])], [numGeometricMesh], ID='EpsXX_corner')
        mesh.add_node_set([np.full_like(corner_lt,NodeEps[1])], [numGeometricMesh], ID='EpsYY_corner')
        mesh.add_node_set([np.full_like(corner_lt,NodeEps[2])], [numGeometricMesh], ID='EpsXY_corner')
        ...
        mesh.add_node_set([bottom],    [numGeometricMesh], ID='bottom')
        mesh.add_node_set([top],       [numGeometricMesh], ID='top')
        mesh.add_node_set([behind],    [numGeometricMesh], ID='behind')
        mesh.add_node_set([front],     [numGeometricMesh], ID='front')
        
        mesh.add_node_set([edge_lb], [numGeometricMesh], ID='edge_lb')
        mesh.add_node_set([edge_lt], [numGeometricMesh], ID='edge_lt')
        mesh.add_node_set([edge_rb], [numGeometricMesh], ID='edge_rb')
        mesh.add_node_set([edge_rt], [numGeometricMesh], ID='edge_rt')

        mesh.add_node_set([edge_bd], [numGeometricMesh], ID='edge_bd')
        mesh.add_node_set([edge_bf], [numGeometricMesh], ID='edge_bf')
        mesh.add_node_set([edge_td], [numGeometricMesh], ID='edge_td')
        mesh.add_node_set([edge_tf], [numGeometricMesh], ID='edge_tf')

        mesh.add_node_set([edge_ld], [numGeometricMesh], ID='edge_ld')
        mesh.add_node_set([edge_lf], [numGeometricMesh], ID='edge_lf')
        mesh.add_node_set([edge_rd], [numGeometricMesh], ID='edge_rd')
        mesh.add_node_set([edge_rf], [numGeometricMesh], ID='edge_rf')
           
        mesh.add_node_set([corner_lbd], [numGeometricMesh], ID='corner_lbd')
        mesh.add_node_set([corner_lbf], [numGeometricMesh], ID='corner_lbf')
        mesh.add_node_set([corner_ltd], [numGeometricMesh], ID='corner_ltd')
        mesh.add_node_set([corner_ltf], [numGeometricMesh], ID='corner_ltf')
        mesh.add_node_set([corner_rbd], [numGeometricMesh], ID='corner_rbd')
        mesh.add_node_set([corner_rbf], [numGeometricMesh], ID='corner_rbf')
        mesh.add_node_set([corner_rtd], [numGeometricMesh], ID='corner_rtd')
        mesh.add_node_set([corner_rtf], [numGeometricMesh], ID='corner_rtf')
                
        mesh.add_node_set([np.full_like(right, NodeEps[0])], [numGeometricMesh], ID='EpsXX_right')
        mesh.add_node_set([np.full_like(right, NodeEps[3])], [numGeometricMesh], ID='EpsXY_right')
        mesh.add_node_set([np.full_like(right, NodeEps[4])], [numGeometricMesh], ID='EpsXZ_right')
        mesh.add_node_set([np.full_like(top,NodeEps[3])],    [numGeometricMesh], ID='EpsXY_top')
        mesh.add_node_set([np.full_like(top,NodeEps[1])],    [numGeometricMesh], ID='EpsYY_top')
        mesh.add_node_set([np.full_like(top,NodeEps[5])],    [numGeometricMesh], ID='EpsYZ_top')
        mesh.add_node_set([np.full_like(front,NodeEps[4])],  [numGeometricMesh], ID='EpsXZ_front')
        mesh.add_node_set([np.full_like(front,NodeEps[5])],  [numGeometricMesh], ID='EpsYZ_front')
        mesh.add_node_set([np.full_like(front,NodeEps[2])],  [numGeometricMesh], ID='EpsZZ_front')

        mesh.add_node_set([np.full_like(edge_lt,NodeEps[0])],[numGeometricMesh], ID='EpsXX_edge_lt')
        mesh.add_node_set([np.full_like(edge_lt,NodeEps[1])],[numGeometricMesh], ID='EpsYY_edge_lt')
        mesh.add_node_set([np.full_like(edge_lt,NodeEps[3])],[numGeometricMesh], ID='EpsXY_edge_lt')
        mesh.add_node_set([np.full_like(edge_lt,NodeEps[4])],[numGeometricMesh], ID='EpsXZ_edge_lt')
        mesh.add_node_set([np.full_like(edge_lt,NodeEps[5])],[numGeometricMesh], ID='EpsYZ_edge_lt')
    
        mesh.add_node_set([np.full_like(edge_bf,NodeEps[1])],[numGeometricMesh], ID='EpsYY_edge_bf')
        mesh.add_node_set([np.full_like(edge_bf,NodeEps[2])],[numGeometricMesh], ID='EpsZZ_edge_bf')
        mesh.add_node_set([np.full_like(edge_bf,NodeEps[3])],[numGeometricMesh], ID='EpsXY_edge_bf')
        mesh.add_node_set([np.full_like(edge_bf,NodeEps[4])],[numGeometricMesh], ID='EpsXZ_edge_bf')
        mesh.add_node_set([np.full_like(edge_bf,NodeEps[5])],[numGeometricMesh], ID='EpsYZ_edge_bf')

        mesh.add_node_set([np.full_like(edge_ld,NodeEps[0])],[numGeometricMesh], ID='EpsXX_edge_ld')
        mesh.add_node_set([np.full_like(edge_ld,NodeEps[2])],[numGeometricMesh], ID='EpsZZ_edge_ld')
        mesh.add_node_set([np.full_like(edge_ld,NodeEps[3])],[numGeometricMesh], ID='EpsXY_edge_ld')
        mesh.add_node_set([np.full_like(edge_ld,NodeEps[4])],[numGeometricMesh], ID='EpsXZ_edge_ld')
        mesh.add_node_set([np.full_like(edge_ld,NodeEps[5])],[numGeometricMesh], ID='EpsYZ_edge_ld')

        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[0])], [numGeometricMesh], ID='EpsXX_corner')
        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[1])], [numGeometricMesh], ID='EpsYY_corner')
        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[2])], [numGeometricMesh], ID='EpsZZ_corner')
        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[3])], [numGeometricMesh], ID='EpsXY_corner')
        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[4])], [numGeometricMesh], ID='EpsXZ_corner')
        mesh.add_node_set([np.full_like(corner_rbd,NodeEps[5])], [numGeometricMesh], ID='EpsYZ_corner')
