...
class elementTriangle(element2D):
    def __init__(self,nb_gp): 
        ...
        if nb_gp == 1:
            ...
            assert 0, "Number of gauss points "+str(nb_gp)+" unavailable for triangle element"           
...
class tri3(elementTriangle):
    def __init__(self, nb_gp=3, **kargs):        
        self.xi_nd = np.c_[[0. , 1., 0.],\
                           [0. , 0., 1.]]
        self.nb_gp = nb_gp
        elementTriangle.__init__(self,nb_gp)     
