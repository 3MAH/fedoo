...
class PlateEquilibriumFI(WeakFormBase):  # plate weakform whith full integration.
    ...
    *:mod:`fedoo.weakform.PlateEquilibrium` should be prefered unless you know
    ...
    drill_stiffness_coefficient : float, default=1e-4
    ...
    def __init__(
        ...
        drill_stiffness_coefficient=1e-4,
        name="",
        nlgeom=None,
        space=None,
    ):
    ...
    def update(self, assembly, pb):
        ...
        if self.nlgeom:
            ...
            assembly.sv["_DrillConstraint"] = assembly.current.get_gp_results(
                op_drill_constraint, dof_local, use_local_dof=True
            )
        else:
            ...
            assembly.sv["_DrillConstraint"] = assembly.get_gp_results(
                op_drill_constraint, dof
            )
...
class PlateShearEquilibrium(
    ...
    def get_weak_equation(self, assembly, pb):
        ...
        # penalty for RotZ (drilling DOF stabilization)
        op_drill_constraint = self.drill_constraint_operator()
        representative_stiffness = H[0][0]  # H[2][2]
        penalty = representative_stiffness * self.drill_stiffness_coefficient
...
def PlateEquilibriumSI(
    ...
    *:mod:`fedoo.weakform.PlateEquilibrium` should be prefered unless you know
    ...
    drill_stiffness_coefficient : float, default=1e-4
        ...
        Typically scaled by the membrane shear stiffness (e.g., 1e-3).
        Increasing this value enforces the constraint more strictly but
        may introduce drilling locking in fully integrated elements.
    name : str, optional
        Name of the WeakForm.
    nlgeom : bool or str, optional
        ...
        If True, a step-by-step frame update is used.
    """
    plate_shear = PlateShearEquilibrium(
        PlateConstitutiveLaw,
    ...
    plate_kl = PlateKirchhoffLoveEquilibrium(
        PlateConstitutiveLaw,
        true_drilling_rotation,
        drill_stiffness_coefficient,
        "",
...
def PlateEquilibrium(
    ...
    # Remark: could be improved for tri3 because membrane interpolation only need 1 gp
