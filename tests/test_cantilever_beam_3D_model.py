...
#Boundary conditions
nodes_left = Mesh.get_all()['Domain'].node_sets["left"]
nodes_right = Mesh.get_all()['Domain'].node_sets["right"]
nodes_top = Mesh.get_all()['Domain'].node_sets["top"]
nodes_bottom = Mesh.get_all()['Domain'].node_sets["bottom"]
...
TensorStrain = Assembly.get_all()['Assembling'].get_strain(Problem.GetDoFSolution(), "Nodal", nlgeom=False)       
