...
mesh_file = Path(__file__).parent / "../util/meshes/gyroid.msh"
fd.mesh.import_file(str(mesh_file), name="Domain")
...
results = pb.add_output(
    "results/thermal3D", "Assembling", ["Temp"], output_type="Node", file_format="npz"
)
