...
#Units: N, mm, MPa
mesh = fd.mesh.box_mesh(nx=31, ny=7, nz=7, x_min=0, x_max=1000, y_min=0, y_max=100, z_min=0, z_max=100, elm_type = 'hex8', name = 'Domain')
...
nodes_load = mesh.find_nodes(f'X=={mesh.bounding_box.xmax} and Y=={mesh.bounding_box.ymax}')
