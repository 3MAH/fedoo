...
pb.bc.add(fd.constraint.PeriodicBC([strain_nodes[0], strain_nodes[1], strain_nodes[0]], ['DispX', 'DispY', 'DispY']))
...
pb.bc.add('Dirichlet',[strain_nodes[1]], 'DispX', 0) #nothing (blocked to avoir singularity)
