...
# Mesh.rectangle_mesh(Nx=51, Ny=51, x_min=-50, x_max=50, y_min=-50, y_max=50, ElementShape = 'quad4', ID ="Domain")
meshID = "Domain"
...
#------------------------------------------------------------------------------
StrainNodes = Mesh.get_all()[meshID].add_nodes(np.zeros(crd.shape[1]),2) 
