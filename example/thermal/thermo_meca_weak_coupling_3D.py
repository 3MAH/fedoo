...
if mat == 0:
    ...
    if mat == 1:
        ...
        mechancial_law = fd.constitutivelaw.Simcoon("EPICP", props, name='MechanicalLaw')
    elif mat == 2:
...
res_m = pb_m.add_output(filename_res+'_me', 'Assembling_M', ['Disp', 'Stress', 'Strain', 'Stress_vm', 'Statev', 'Wm'])    
