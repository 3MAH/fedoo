...
* Improve contact formulation and add friction
* Support an efficient file format based on HDF5 to save and load data
* Improve the management of local frame
* Export results on several meshes
